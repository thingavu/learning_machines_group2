...
try:
    ...
    RESULTS_DIR = "/Users/arina/Projects/LearningMachines/learning_machines_robobo/examples/group2/results"
    print(
...
DEBUG_FLAG = True
DEBUG_INTERVAL = 1  # Save 1 in every 10 images processed
...
if __name__ == "__main__":
    ...
    for batch_start in range(0, total_images, BATCH_SIZE):
        ...
        for img_file in batch_files:
            ...
            print(f"\n{img_file}: \n"
                  f"Green Count = {features['green_pixel_count']}, \n"
                  # f"Mask = {features['mask']}, "
                  f"Nearest Object Area = {features['nearest_object_area']}, \n"
                  f"Nearest Object Centroid = {features['nearest_object_centroid']}, \n"
                  f"Distance to Lower Center = {features['distance_to_lower_center']}")
                  # f"Considered Contours = {features['considered_contours']}, "
                  # f"Processed Image = {features['processed_image']}, "
                  # f"Annotated Image = {features['annotated_image']}")
